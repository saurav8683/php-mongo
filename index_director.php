...
<html lang="en">
  ...
  <body>
    ...
    <?php include 'topnav_director.php';?>
    ...
    <main role="main">
      ...
      <div class="jumbotron">
        <div class="container">
          ...
          <p><a class="btn btn-primary btn-lg" href="info_register_director.php" role="button">Add | Edit &raquo;</a></p>
          <p><a class="btn btn-primary btn-lg" href="leave_to_check_director.php" role="button">Leaves To Check &raquo;</a></p>
        </div>
      </div>
