    ...
    <main role="main">
      ...
      <div class="jumbotron">
        <div class="container">
          ...
          <p><a class="btn btn-primary btn-lg" href="info_register_dean.php" role="button">Add | Edit &raquo;</a></p>
          <p><a class="btn btn-primary btn-lg" href="leave_form_dean.php" role="button">Apply for Leave &raquo;</a></p>
          <p><a class="btn btn-primary btn-lg" href="leave_status_dean.php" role="button">Leave Status &raquo;</a></p>
          <p><a class="btn btn-primary btn-lg" href="leave_to_check_dean.php" role="button">Leaves To Check &raquo;</a></p>
        </div>
      </div>
