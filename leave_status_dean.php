        ...
        <div class="container">
          ...
          <p>
            <?php
              ...
              $sql = "SELECT id FROM faculty WHERE faculty.firstname = '$firstname' and faculty.lastname = '$lastname' ;";

              $id = mysqli_fetch_assoc(mysqli_query($conn, $sql));
              
              $sql2 = "SELECT * FROM leave_portal WHERE person_id = $id[id] ;";
              ...
              if(mysqli_num_rows($result) > 0){
                ...
                while($row = mysqli_fetch_assoc($result)){
                    ...
                    if($row['leave_status'] == 1){
                      ...
                      $sql = "SELECT * FROM comment_portal WHERE leave_id='$leave_id';";
